  ...
  const personal = [
    {
      ...
      content: [
        ...
        [
          "일곱 번째 프로젝트에서는 기존 라이징 서비스를 기반으로 AIT 서비스를 구축하는 복제·컨버팅 작업을 진행했습니다.",
          "기존 Nuxt 프로젝트의 구조와 기능을 분석해 AIT 서비스 정책에 맞게 화면과 로직을 수정하고 신규 기능을 추가했습니다.",
