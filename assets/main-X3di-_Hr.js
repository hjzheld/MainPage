...
`,Bz={back:"Back-end",front:"Front-end",database:"Database",ai:"AI",build:"Build 도구"},Uz=()=>{var M,O;const[n,t]=k.useState(null),[r,a]=k.useState(!1),[s,u]=k.useState(0),[c,f]=k.useState(0);k.useEffect(()=>{const R=localStorage.getItem("project");R&&t(JSON.parse(R))},[]);const h=(n==null?void 0:n.detail.image.length)??0,p=s>0,g=s<h-1,y=c>0,x=c<h-1,v=R=>{f(R),a(!0)},_=()=>{a(!1)},S=()=>{p&&u(R=>R-1)},C=()=>{g&&u(R=>R+1)},A=()=>{y&&f(R=>R-1)},D=()=>{x&&f(R=>R+1)};return k.useEffect(()=>{if(!r)return;const R=document.body.style.overflow,N=document.documentElement.style.overflow;document.body.style.overflow="hidden",document.documentElement.style.overflow="hidden";const z=B=>{if(B.key==="Escape"){a(!1);return}B.key==="ArrowLeft"&&f(X=>Math.max(X-1,0)),B.key==="ArrowRight"&&f(X=>Math.min(X+1,Math.max(h-1,0)))};return window.addEventListener("keydown",z),()=>{document.body.style.overflow=R,document.documentElement.style.overflow=N,window.removeEventListener("keydown",z)}},[r,h]),w.jsx(Ty,{children:n?w.jsxs(w.Fragment,{children:[w.jsxs(ct.div,{className:"detail-container",variants:Tz,initial:"hidden",animate:"visible",children:[w.jsx(G5,{page:"detail",title:n.title}),w.jsxs(ct.div,{className:"detail-content-container",variants:id,initial:"hidden",animate:"visible",children:[w.jsx(Dz,{className:"detail-img-container",variants:a0,children:n.detail.image.length===1?w.jsx(ct.img,{src:n.detail.image[0].src,loading:"lazy",alt:"프로젝트 이미지",onClick:()=>v(0),whileHover:{scale:1.04,rotate:.5},whileTap:{scale:.96},transition:{type:"spring",stiffness:250,damping:18}}):w.jsxs(jz,{onClick:()=>v(s),children:[w.jsx(zz,{src:(M=n.detail.image[s])==null?void 0:M.src,loading:"lazy",alt:`${n.title} 프로젝트 이미지 ${s+1}`,initial:{opacity:0},animate:{opacity:1},transition:{duration:.2},draggable:!1},s),w.jsx(Yw,{type:"button",$direction:"prev","aria-label":"이전 이미지",disabled:!p,onClick:R=>{R.stopPropagation(),S()}}),w.jsx(Yw,{type:"button",$direction:"next","aria-label":"다음 이미지",disabled:!g,onClick:R=>{R.stopPropagation(),C()}})]})}),w.jsxs(Oz,{className:"detail-content",variants:Qr,children:[w.jsx(Cz,{variants:Qr,children:n.content}),w.jsx(ct.p,{className:"detail-sub-content",variants:Qr,dangerouslySetInnerHTML:{__html:n.detail.content}}),n.detail.video&&w.jsx(ct.div,{className:"video-wrap",variants:a0,initial:"hidden",whileInView:"visible",viewport:nd,children:w.jsx("video",{src:n.detail.video,poster:Sz,autoPlay:!0,playsInline:!0,controls:!0,muted:!0,"aria-label":"시연영상"})}),w.jsxs(ct.div,{variants:id,initial:"hidden",whileInView:"visible",viewport:nd,children:[n.detail.github&&w.jsx(ct.div,{variants:Qr,children:w.jsx(ed,{title:"GitHub",links:n.detail.github})}),n.detail.notion&&w.jsx(ct.div,{variants:Qr,children:w.jsx(ed,{title:"Notion",links:n.detail.notion})}),n.detail.site&&w.jsx(ct.div,{variants:Qr,children:w.jsx(ed,{title:"URL",links:n.detail.site})}),n.detail.blog&&n.detail.blog.length>0&&w.jsx(ct.div,{variants:Qr,children:w.jsx(ed,{title:"Blog",links:n.detail.blog})})]}),w.jsx(Ez,{variants:Qr,initial:"hidden",whileInView:"visible",viewport:nd,children:"기술 스택"}),n.detail.stack&&Object.entries(n.detail.stack??{}).map(([R,N])=>{const z=R,B=N;return B.length===0?null:w.jsxs(ct.div,{initial:"hidden",whileInView:"visible",viewport:nd,variants:id,children:[w.jsx(Az,{variants:Qr,children:Bz[z]}),w.jsx(Mz,{variants:id,children:B.map(X=>w.jsx(Rz,{variants:a0,whileHover:{scale:1.08,y:-4,background:"rgba(118, 164, 218, 0.25)",borderColor:"var(--primary-color)"},whileTap:{scale:.96},children:X},X))})]},z)})]})]})]}),w.jsx(Dd,{children:r&&w.jsxs(kz,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},onClick:_,children:[w.jsx(Lz,{initial:{opacity:0,scale:.92},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.96},transition:{duration:.18},onClick:R=>R.stopPropagation(),children:w.jsx(Nz,{src:(O=n.detail.image[c])==null?void 0:O.src,alt:`${n.title} 프로젝트 이미지 ${c+1}`,initial:{opacity:0},animate:{opacity:1},transition:{duration:.18},draggable:!1},c)}),h>1&&w.jsxs(w.Fragment,{children:[w.jsx(Gw,{type:"button",$direction:"prev","aria-label":"이전 이미지",disabled:!y,onClick:R=>{R.stopPropagation(),A()}}),w.jsx(Gw,{type:"button",$direction:"next","aria-label":"다음 이미지",disabled:!x,onClick:R=>{R.stopPropagation(),D()}}),w.jsxs(Pz,{children:[c+1," / ",h]})]}),w.jsx(Vz,{type:"button","aria-label":"이미지 크게 보기 닫기",onClick:R=>{R.stopPropagation(),_()}})]})})]}):w.jsx("p",{children:"프로젝트 정보를 불러오는 중..."})})},Hz=P(ct.div)`
  width: 100%;
  height: 100%;
  padding: 2rem;
  margin-bottom: 0;
